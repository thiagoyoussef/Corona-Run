...
def load_players(assets):
    players = {}
    players[KRATOS] = [assets[KRATOS], 130,115, False, 21]
    players[DINO] = [assets[DINO], 250, 100, True, 0]
    players[SONIC] = [assets[SONIC], 125, 80, False, 5]
    players[MARIO] = [assets[MARIO], 55, 55, False, 0]
    players[YOSHI] = [assets[YOSHI], 100, 60, False, 3]
    players[DEADPOOL] = [assets[DEADPOOL], 110, 110, False, 20]
    players[CORONITA] = [assets[CORONITA], 100, 120, False, 12]
    players[ASH] = [assets[ASH], 50, 70, False, 1]
    players[FLAPPY] = [assets[FLAPPY], 110, 80, False, 20]
    return players