import pygame
from Parameters import img_dir, SCORE_FONT, FPS, WIDTH, HEIGHT, BLACK, RED, BLUE, GRAVITY, JUMP, MEGA_JUMP_1, MEGA_JUMP_2, GROUND, STILL, JUMPING, FALLING, DEATH, world_speed, INITIAL_CACTOS, INITIAL_BLOCKS, TILE_SIZE, BOSS_SIZE
from Assets import game_over_screen, load_assets, load_spritesheet, PLAYER_IMG, BOSS_IMG, CACTOS_IMG, PUKE_IMG, BLOCK_IMG, BACKGROUND_IMG
from Class import Tile, Player, Boss, Puke, Cactos
import random
